...
//  iOS Build Variant
//
//  Created by Pintu on 23/12/23.
//  Copyright © 2023 dwirandyh. All rights reserved.
//
...
extension PKIAPHandler: SKProductsRequestDelegate, SKPaymentTransactionObserver{
    ...
    func productsRequest (_ request:SKProductsRequest, didReceive response:SKProductsResponse) {
        ...
        if (response.products.count > 0) {
           ...
           // Loader.hideLoader()
           // CommonUtils.showToast(message: "Product not available for purchage!")
         //   self.addAlert(ALERTS.KERROR, message:"Product not available for purchage!" , buttonTitle: ALERTS.kAlertOK)
