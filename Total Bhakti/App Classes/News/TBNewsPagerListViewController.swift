//
//  TBNewsPagerListViewController.swift
//  Sanskar
//
//  Created by Shouaib Ahmed on 24/07/21.
//  Copyright © 2021 MAC MINI. All rights reserved.
//

import UIKit

class TBNewsPagerListViewController:TBInternetViewController {
    //MARK:- IBOutlets.
...
extension TBNewsPagerListViewController : TBHeaderDelegates {
...
extension TBNewsPagerListViewController : TBchannelTableDelegate {
 ...
 extension TBNewsPagerListViewController : FSPagerViewDelegate {
...
extension TBNewsPagerListViewController : FSPagerViewDataSource {
    ...
    public func pagerView(_ pagerView: FSPagerView, cellForItemAt index: Int) -> FSPagerViewCell {
        ...
        let shortDesc = allNewsDataArr[index].description

        if let url = URL(string: imageArray ?? "") {
            cell.contentView.frame = self.pagerView.frame
