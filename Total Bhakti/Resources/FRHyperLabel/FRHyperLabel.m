...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:236.0/255.0 green:90.0/255.0 blue:110.0/255.0 alpha:1];
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:85/255.0 green:85/255.0 blue:85/255.0 alpha:1];
	}
}
