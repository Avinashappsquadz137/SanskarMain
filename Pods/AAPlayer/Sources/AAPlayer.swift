...
public class AAPlayer: UIView {
    ...
    @objc fileprivate func initWithPlayButton() {
    ...
    fileprivate func setPlayerSubviewsFrame() {
        ...
        if UserDefaults.standard.object(forKey: "hiderotation") != nil {
            rotateSizeButton.isHidden = true
        }
        
        //rotateSizeButton.backgroundColor = UIColor.red
    }
