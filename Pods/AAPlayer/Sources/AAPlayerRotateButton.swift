...
class AAPlayerRotateButton: UIButton {
    ...
    @objc fileprivate func setDisplaySize() {
        ...
        if isSelected {
            ...
            isSelected = false
            //notification for show top
             NotificationCenter.default.post(name: NSNotification.Name(rawValue : "backToSame"), object: nil)
            ...
            isSelected = true
            //notification
            NotificationCenter.default.post(name: NSNotification.Name(rawValue : "userTapRotate"), object: nil)
